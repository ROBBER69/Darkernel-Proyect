...
#define OMAP4430_VDD_MPU_OPP25_UV		890000   /*250 MHz*/
#define OMAP4430_VDD_MPU_OPP50_UV		920000   /*350 MHz*/
#define OMAP4430_VDD_MPU_OPP100_UV		940000   /*450 MHz*/
#define OMAP4430_VDD_MPU_OPP150_UV		1000000   /*600 MHz*/
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1080000   /*858 MHz*/
#define OMAP4430_VDD_MPU_OPPNITRO_UV		1225000   /*1008 MHz*/
#define OMAP4430_VDD_MPU_OPPNITRO2_UV		1275000   /*1108 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROSB_UV		1320000   /*1208 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROSB2_UV	1340000   /*1254 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROC2_UV		1355000   /*1308 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROC3_UV		1365000   /*1358 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROC4_UV		1385000   /*1408 MHz*/
#define OMAP4430_VDD_MPU_OPPNITROC5_UV		1410000   /*1508 MHz*/
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP150_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROC2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB2, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROC3_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB2, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROC4_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB3, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROC5_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB3, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
#define OMAP4430_VDD_CORE_OPP100_OV_UV		1220000
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROC2_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROC3_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROC4_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROC5_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 75000000, OMAP4430_VDD_MPU_OPPOFF_UV),
  	/* MPU OPP0 - OPP00 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 150000000, OMAP4430_VDD_MPU_OPP00_UV),
  	/* MPU OPP1 - OPP25 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 250000000, OMAP4430_VDD_MPU_OPP25_UV),
	/* MPU OPP2 - OPP50 */
	...
	/* MPU OPP4 - OPP150 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 600000000, OMAP4430_VDD_MPU_OPP150_UV),
	/* MPU OPP5 - OPP-Turbo */
	...
	/* MPU OPP9 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1308000000, OMAP4430_VDD_MPU_OPPNITROC2_UV),
	/* MPU OPP10 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1350000000, OMAP4430_VDD_MPU_OPPNITROC3_UV),
	/* MPU OPP10 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1408000000, OMAP4430_VDD_MPU_OPPNITROC4_UV),
	/* MPU OPP11 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1500000000, OMAP4430_VDD_MPU_OPPNITROC5_UV),
	/* L3 OPP1 - OPP50 */
...
int __init omap4_opp_init(void)
{
	...
	if (omap4_has_mpu_1_25ghz())
		omap4_opp_enable("mpu", 1250000000);
